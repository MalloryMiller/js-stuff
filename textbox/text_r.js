...
class DialogueBox {
    static current_box = DialogueBox([]);
    ...
    static newText(to_say) {

        current_box.newText(to_say);
    ...
    deleteText(anim_event, starting=false){
